// This is the list of class names that should not be hashed
// by the nextjs css rules
const preventFromHash = ["dark", "sidebar-expanded"]
          ...
          l.options = {
            ...
            modules: {
              ...
              getLocalIdent: (ctx, localIdentName, localName) => {
                ...
                if (preventFromHash.includes(localName)) return localName
